...
npm run verify           # lint + test + test:integration + security + check:governance — the full gate (scripts/verify.js; prints a final ✅/❌ verdict line so the result survives `| tail` and can't false-green)
```
