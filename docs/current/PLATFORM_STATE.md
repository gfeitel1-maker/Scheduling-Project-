...
| `import` | `src/screens/ImportScreen.jsx` | Onboarding/reconciliation: ingest a prior-year schedule or workbook, surface recognition matches and held conflicts |
...
(SQLite, one file per device — `electron/db/schema.sql`, schema v29 as of this writing)
