...
> **Describes the retired Supabase/Postgres/RLS architecture, or its removal.** That backend no longer exists — see `CLAUDE.md`. Accurate as of its date; never current instruction.
