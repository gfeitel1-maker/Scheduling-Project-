...
| Ticket | Status | Referenced by |
|---|---|---|
| [T34-ingest-infer-fixed-event-blocks](../../docs/work/tickets/T34-ingest-infer-fixed-event-blocks.md) | open | — |
