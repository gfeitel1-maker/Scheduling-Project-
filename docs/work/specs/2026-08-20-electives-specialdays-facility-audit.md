...
| **Field-Trip stamps** (`FieldTripDrawer.jsx`, retired) | `template_overlays` (retired) | *event/context* (a label, not an assignment) | Retired 2026-08-30 — see docs/adr/2026-08-30-retire-overlay-stamp-subsystem.md; was a label-only banner over the normal grid |
