...
6. **Credential-signature replay + degrade-window permanence (T165) — RESOLVED 2026-09-15.** The two
   ...
   closed. See `docs/work/tickets/T165-...` and `docs/work/security/2026-09-15-Q1-enforcement-merge-review.md`.
