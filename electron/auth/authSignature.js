...
// signed tuple (T165 replay defense) — a v1 signature no longer verifies, which is intended: the
...
// older genuinely-signed tuple (T165): projection rejects a verified tuple whose version is not
