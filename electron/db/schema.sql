...
CREATE TABLE IF NOT EXISTS users (
  ...
  -- Host Ed25519 signature over {id, role, pin_hash, pin_salt, cred_version} (docs/adr/2026-09-14-users-auth-fields-off-the-replicated-document.md, T165).
  ...
  -- tuple whose version is older than the local row's — this is the T165 replay/rollback defense.
