...
const styles = {
  ...
  chip: S.chip('var(--primary)', false, { borderRadius: 999, border: '1px solid var(--border)' }),
  chipSelected: S.chip('var(--primary)', true, { borderRadius: 999, border: '1px solid var(--primary)' }),
  cardHold: {
